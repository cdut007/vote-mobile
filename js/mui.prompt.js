...
(function($, window, document) {
	...
	var createInput = function(placeholder,maxlength) {
		return '<div class="' + CLASS_POPUP_INPUT + '"><input maxlength="'+maxlength+'" type="text" autofocus placeholder="' + (placeholder || '') + '"/></div>';
	};
	 ...
	 */
	var createPromptInput = function(message, placeholder, title, btnArray, callback, type, maxlength) {
		...
		if(!$.os.plus || type === 'div') {
			return createPopup(createInner(message, title || '提示', createInput(placeholder, maxlength)) + createButtons(btnArray || ['取消', '确认']), callback);
		}
